...
public class XideoLoginErrorMessageNeg extends ActivityInstrumentationTestCase2<FirstRun>
{
	private Solo solo;

	public XideoLoginErrorMessageNeg() {
	...
	public void testXideoLoginErrorMessageNeg()
	{
		...
		if (!Build.MODEL.toLowerCase(Locale.US).contains("comcast")) {
			...
			solo.enterText((EditText) solo.getCurrentActivity().findViewById(com.xfinity.xidio.R.id.first_run_username),"test_1215");

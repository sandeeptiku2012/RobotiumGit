...
public class XideoLoginDigitUsername extends ActivityInstrumentationTestCase2<FirstRun>
{
	private Solo solo;

	public XideoLoginDigitUsername() {
	...
	public void testXideoLoginDigitUsername()
	{
		...
		if (!Build.MODEL.toLowerCase(Locale.US).contains("comcast")) {
			...
			solo.enterText((EditText) solo.getCurrentActivity().findViewById(com.xfinity.xidio.R.id.first_run_username),"1578946312");

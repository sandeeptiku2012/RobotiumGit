...
public class XideoLoginInvalidUsername extends ActivityInstrumentationTestCase2<FirstRun>
{
	private Solo solo;

	public XideoLoginInvalidUsername() {
	...
	public void testXideoLoginInvalidUsername()
	{
		...
		if (!Build.MODEL.toLowerCase(Locale.US).contains("comcast")) {
			...
			solo.enterText((EditText) solo.getCurrentActivity().findViewById(com.xfinity.xidio.R.id.first_run_username),"asdoikaoidj");

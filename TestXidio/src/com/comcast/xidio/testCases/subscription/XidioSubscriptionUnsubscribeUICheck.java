...
public class XidioSubscriptionUnsubscribeUICheck extends ActivityInstrumentationTestCase2<FirstRun>
{
	...
	public void testXidioSubscriptionUnsubscribeUICheck() 
	{
		...
		{
			Log.e("Exception:", "Exception occured in XidioSubscriptionUnsubscribeUICheck test cases.", e);
		}
		...
		catch (JSONException e)
		{
			...
			Log.e("Exception:", "Exception occured in XidioSearchUpNextResult in get channel title.", e);
		}
